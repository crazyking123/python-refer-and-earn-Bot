...
BOT_TOKEN = os.environ["7106457456:AAFF0bUPYPpyKbvyNiHXiae4L_0UUNXuGGE"]
PAYMENT_CHANNEL = "@crazypayments" #add payment channel here including the '@' sign
OWNER_ID = 2023327451 #write owner's user id here.. get it from @MissRose_Bot by /id
CHANNELS = ["@crazypayments"] #add channels to be checked here in the format - ["Channel 1", "Channel 2"] 
...
bot = telebot.TeleBot(7106457456:AAFF0bUPYPpyKbvyNiHXiae4L_0UUNXuGGE)
